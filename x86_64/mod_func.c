...
extern void _ExpGABAabFluct_reg(void);
extern void _ExpGABAab_reg(void);
extern void _fastconn_reg(void);
extern void _GFluct_ThreadSafe_reg(void);
extern void _iconc_Ca_reg(void);
extern void _MyExp2SidFluct_reg(void);
...
void modl_reg(){
  if (!nrn_nobanner_) if (nrnmpi_myid < 1) {
    ...
    fprintf(stderr," \"ExpGABAabFluct.mod\"");
    fprintf(stderr," \"ExpGABAab.mod\"");
    fprintf(stderr," \"fastconn.mod\"");
    fprintf(stderr," \"GFluct_ThreadSafe.mod\"");
    fprintf(stderr," \"iconc_Ca.mod\"");
    fprintf(stderr," \"MyExp2SidFluct.mod\"");
