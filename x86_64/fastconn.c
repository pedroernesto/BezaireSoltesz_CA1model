...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _fastconn_reg() {
  ...
  _initlists();
 	...
 	ivoc_help("help ?1 fastconn /home/pedroernesto/Documents/Project/Code/Models_Validation/Models_to_test/Hippocampus/BezaireSoltesz_CA1model/modeldbca1/fastconn.mod\n");
 }
static int _reset;
