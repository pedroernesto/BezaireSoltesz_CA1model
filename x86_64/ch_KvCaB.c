...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 ch_KvCaB /users/bp000108/BezaireSoltesz_CA1model_Slicing/modeldbca1/ch_KvCaB.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/users/bp000108/BezaireSoltesz_CA1model_Slicing/modeldbca1/ch_KvCaB.mod";
static const char* nmodl_file_text = 
